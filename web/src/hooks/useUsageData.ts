...
export function useLanguageUsagePerDay(timeframe: Timeframe) {
  return useQuery({
    queryKey: ['languageUsagePerDay', timeframe],
    queryFn: () => api.fetchLanguageUsagePerDay(timeframe),
  });
}
...
export function useSeatInfo(timeframe: Timeframe) {
  return useQuery({
    queryKey: ['seatInfo', timeframe],
    queryFn: () => api.fetchSeatInfo(timeframe),
  });
}
